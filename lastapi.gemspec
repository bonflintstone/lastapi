Gem::Specification.new do |s|
  ...
  s.files       = ['lib/lastapi.rb', 'lib/lastapi/cipher.rb', 'lib/lastapi/startup.rb','lib/lastapi/config.rb' ,'lib/lastapi/special_handler.rb', 'lib/lastapi/accounts.rb', 'lib/lastapi/accounts_cache.rb']
